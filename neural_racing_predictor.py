...
# Store results in Cosmos DB (if enabled and available)
        ...
        if store_in_cosmos:
            try:
                ...
                # Clean results_data to handle NaN values for JSON serialization
                ...
                cleaned_results_data = clean_nan_values(results_data)
                cosmos_document = {
                    'id': prediction_id,
                    'race_date': args.date,
                    'venue': args.venue,
                    ...
                    **cleaned_results_data  # Include all the cleaned results data
                }
